...
''' use the dictionary to create a data frame with the produce names as 
    rows and columns named - "Cost Per Pound", "Quantity Sold" and "Total Sale". 
...
## Creating data frame and making indexes
...
print('Highest sales: ', produce.idxmax()['Total Sales'], "${:,.2f}".format(produce.max()['Total Sales']))
print('Lowest sales: ',produce.idxmin()['Total Sales'], "${:,.2f}".format(produce.min()['Total Sales']))
print()
...
print('Apricots before update: ')
print(produce.loc['Apricots',['Quantity Sold','Total Sales']])
produce.at['Apricots','Quantity Sold'] = 11955
produce.at['Apricots','Total Sales'] = 44353.05
print()
print('Apricots after update: ')
print(produce.loc['Apricots',['Quantity Sold','Total Sales']])
print()


print("5. What is the average quantity sold across all products? (print out ONLY quantity sold)")
print('Average quantity sold for all products:',produce['Quantity Sold'].mean())
print()


print("6. Create a new dataframe for only those produce that have sold between 11,500 to 12,000 (quantity)")
specific_quantity = produce.loc[(produce['Quantity Sold'] >= 11500) & (produce['Quantity Sold'] <= 12000)]
print(specific_quantity)
print()


print("7. What is the total sales for the products in the above new dataframe? (print out ONLY total sales)")
print('Total sales for products that have sold between 11,500 to 12,000 units:', "${:,.2f}".format(produce['Total Sales'].sum()))
